...
namespace EdgeAlignInspect
{
	public class Form1 : Form
	{
		...
		private void InitializeComponent()
		{
			...
			EdgeAlignInspect.Form1.SetupButton(this.btnAddBaseRoi, "添加线基准", 14, 60, 104, 30, false);
			EdgeAlignInspect.Form1.SetupButton(this.btnAddCircleBaseRoi, "添加圆基准", 126, 60, 104, 30, false);
			EdgeAlignInspect.Form1.SetupButton(this.btnAddCirclePointRoi, "添加圆点基准", 238, 60, 122, 30, false);
